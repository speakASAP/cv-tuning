...
function App() {
  ...
  const loadApplication = async (application: Row) => {
    ...
    setSelected({ ...current, jobTitle: application.jobTitle ?? null, jobCompany: application.jobCompany ?? null }); setRenders(rows);
