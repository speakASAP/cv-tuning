...
function App() {
  ...
  const run = async (work: () => Promise<void>) => {
    ...
    try { await work(); } catch (cause) { setError(errorMessage(cause)); } finally { busyRef.current = false; setBusy(false); }
  };
