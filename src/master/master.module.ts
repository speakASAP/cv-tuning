...
@Module({
  imports: [TypeOrmModule.forFeature([CvProfileEntity, CvMasterEntity, CvFactEntity]), AuthModule, AiModule],
  controllers: [MasterCvController],
  providers: [MasterCvService, FactExtractorService, GdocsImporter],
