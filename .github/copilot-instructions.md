# Copilot Compatibility Instructions - `cv-tuning`
...
Repository: [https://github.com/speakASAP/cv-tuning](https://github.com/speakASAP/cv-tuning)
Authoritative checkout: `/home/ssf/Documents/Github/cv-tuning` on `alfares`.
