# Copilot Instructions — `cv-tuning`
...
- **Authoritative path**: `/home/ssf/Documents/Github/cv-tuning` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/cv-tuning.git`, branch `main`.
...
3. This repo, in order: `AGENTS.md` `STATE.json` `CLAUDE.md`
